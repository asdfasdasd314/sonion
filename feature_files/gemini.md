...
- The estimate route injects the food-tool skill, repeats model turns only for protocol tool calls, and returns only validated final content.
...
- `lib/agent/runner.ts` bounds turns, calls, payloads, and deadline.
