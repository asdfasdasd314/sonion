...
## Corpus Check
- 65 files · ~24,091 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 506 nodes · 951 edges · 26 communities (20 shown, 6 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b4d64b06`
...
Cohesion: 0.07
Nodes (45): DELETE(), errorResponse(), getMealId(), mapError(), PATCH(), errorResponse(), GET(), mapError() (+37 more)
...
Cohesion: 0.22
Nodes (14): errorResponse(), isPromptBody(), POST(), PromptBody, getFoodToolsSkill(), getDefaultFoodToolRegistry(), AlternatingModelSelector, createGemmaClient() (+6 more)

### Community 18 - "tools.ts"
Cohesion: 0.14
Nodes (27): loadParameters(), MEAL_ESTIMATION_PARAMETERS, MealEstimationParameters, parameterValue(), caloriesFromMacros(), estimateMeal(), MealEstimationError, portionUnitMilliliters() (+19 more)
...
Cohesion: 0.08
Nodes (41): formatDate(), formatTime(), HistoryState, MacroSummary(), MealDetails(), MealDetailsProps, MealHistory(), MealHistoryProps (+33 more)
