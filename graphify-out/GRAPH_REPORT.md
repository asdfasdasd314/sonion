...
## Corpus Check
- 93 files · ~202,860 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 666 nodes · 1344 edges · 32 communities (26 shown, 6 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7fb1ceae`
...
Cohesion: 0.11
Nodes (32): DELETE(), errorResponse(), getMealId(), mapError(), PATCH(), errorResponse(), GET(), mapError() (+24 more)
...
Cohesion: 0.08
Nodes (48): checkEnvelopeKeys(), DEFAULT_PROTOCOL_LIMITS, diagnostic(), duplicateTopLevelKeys(), fieldDiagnostic(), formatProtocolErrors(), formatResult(), formatRevision() (+40 more)
...
Cohesion: 0.13
Nodes (22): Home(), AuthMode, AuthPanel(), AuthPanelProps, mealListFingerprint(), AuthErrorResponse, authRequest(), AuthResponse (+14 more)
...
Cohesion: 0.07
Nodes (49): AgentGenerationAdapter, selectPreferredVolumePortion(), loadParameters(), MEAL_ESTIMATION_PARAMETERS, MealEstimationParameters, parameterValue(), caloriesFromMacros(), estimateMeal() (+41 more)
...
Cohesion: 0.07
Nodes (48): formatDate(), formatTime(), HistoryState, MacroSummary(), MealDetails(), MealDetailsProps, MealHistory(), MealHistoryProps (+40 more)

### Community 22 - "normalize.ts"
Cohesion: 0.08
Nodes (39): errorResponse(), persistInterpretationFailure(), POST(), processQueuedMeal(), processQueuedRefinement(), getFoodToolsSkill(), AlternatingModelSelector, createGemmaClient() (+31 more)
...
Cohesion: 0.08
Nodes (39): errorResponse(), mapError(), PATCH(), errorResponse(), GET(), mapError(), ErrorsState, formatMealWhen() (+31 more)
...
## Knowledge Gaps
- **212 isolated node(s):** `geistSans`, `geistMono`, `metadata`, `AuthMode`, `AuthPanelProps` (+207 more)
...
- **Why does `NormalizedFood` connect `TypeScript References` to `Project Agent Rules`, `normalize.ts`, `tools.ts`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `FoodDataSetupError` connect `TypeScript References` to `index.ts`, `normalize.ts`?**
